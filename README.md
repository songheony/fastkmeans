...
[![Downloads](https://static.pepy.tech/badge/fastcluster/month)](https://pepy.tech/project/fastcluster)
...
Welcome to `fastkmeans`! This is an extremely tiny library meant to provide a decently fast, CPU/GPU-compatible k-means implementation without any install woes, relying on just pure PyTorch and Numpy.\
